...
class SingleFilePipelineStorage(PipelineStorage):
    ...
    def child(self, name: str | None) -> "PipelineStorage":
        ...
        if name is None:
            return self
        return SingleFilePipelineStorage(str(Path(self._root_dir) / Path(name)))
...
def create_file_storage(**kwargs: Any) -> PipelineStorage:
    ...
    return SingleFilePipelineStorage(root_dir=base_dir)
